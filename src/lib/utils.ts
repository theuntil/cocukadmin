...
export const ORDER_STATUS_TR: Record<string, string> = {
  /* Kart dijital: hazırlık ve kargo aşaması yok. Bu iki durum
     migration 074 ile kaldırıldı; eski kayıtlar için karşılıkları
     duruyor ama yeni sipariş bu durumlara düşmez. */
...
/** Etkinlik durumları */
export const EVENT_STATUS_TR: Record<string, string> = {
  draft: "Taslak",
  published: "Yayında",
