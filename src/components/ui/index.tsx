...
export function H1({ className, children }: { className?: string; children: React.ReactNode }) {
  return (
    <h1 className={cn("font-display text-[38px] leading-[1.02] font-semibold tracking-[-.035em] sm:text-[52px] lg:text-[68px] lg:leading-[.98]", className)}>
      {children}
    </h1>
  );
}
...
export function H2({ className, children }: { className?: string; children: React.ReactNode }) {
  return (
    <h2 className={cn("font-display text-[28px] leading-[1.05] font-semibold tracking-[-.03em] sm:text-[36px] lg:text-[44px]", className)}>
      {children}
    </h2>
  );
}
...
export function H3({ className, children }: { className?: string; children: React.ReactNode }) {
  return <h3 className={cn("font-display text-[20px] font-semibold tracking-[-.02em] sm:text-[24px]", className)}>{children}</h3>;
}
