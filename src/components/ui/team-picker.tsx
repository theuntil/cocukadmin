...
function TeamSheet({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[220] flex items-end justify-center"
      ...
      <div
        className="absolute inset-0 bg-[rgba(15,31,26,.55)] backdrop-blur-[2px] transition-opacity duration-[260ms]"
                ...
                return (
                  <button
                    ...
                    className={`relative flex aspect-square flex-col items-center justify-center gap-2 rounded-[16px] border p-2.5 transition-all sm:gap-2.5 sm:p-3 ${
                      active
                        ? "border-ink bg-chip shadow-[0_2px_10px_-4px_rgba(15,31,26,.25)]"
                  ...
                  >
                    ...
                    <TeamLogo team={t} size={40} className="sm:h-12 sm:w-12" />
